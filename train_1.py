...
parser.add_argument('--epoch-size', default=400, type=int, metavar='N', help='manual epoch size (will match dataset size if not set)')
# optimizer param
...
# logger 
parser.add_argument('--name', dest='name', default="vivid_resnet18_indoor", type=str, required=False, help='name of the experiment, checkpoints are stored in checpoints/name')
parser.add_argument('--print-freq', default=10, type=int, metavar='N', help='print frequency')
parser.add_argument('--log-summary', default='progress_log_summary.csv', metavar='PATH', help='csv where to save per-epoch train and valid stats')
parser.add_argument('--log-full', default='progress_log_full.csv', metavar='PATH', help='csv where to save per-gradient descent train stats')
parser.add_argument('--log-output', action='store_true', default=True, help='will log dispnet outputs at validation step')
# data loader
...
def main():
    ...
    # SequenceFolder is used to load and transform the dataset. we will pass how transformation should be done  
