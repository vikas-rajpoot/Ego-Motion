...
# inverse_warp from SC-sfm-learner paper
def inverse_warp2(img, depth, ref_depth, pose, intrinsics, padding_mode='zeros'):
    ...
    """
#    check_sizes(img, 'img', 'B3HW') # B1HW, B3HW
...
#    check_sizes(pose, 'pose', 'B6')
    ...
    rot, tr = proj_cam_to_src_pixel[:, :, :3], proj_cam_to_src_pixel[:, :, -1:]
    src_pixel_coords, computed_depth = cam2pixel(cam_coords, rot, tr, padding_mode)  # [B,H,W,2]
