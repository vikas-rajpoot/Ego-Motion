...
class ThermalCamera:
    ...
    def find_hottest_region_center(self, thermal_image):
        ...
        normalized_img = cv2.normalize(thermal_image_celsius, None, 0, 255, cv2.NORM_MINMAX)
        ...
        center_x, center_y = color_mapped_img.shape[1] // 2, color_mapped_img.shape[0] // 2
    ...
    def display_live_feed(self):
        ...
        while True:
            ...
            print(f"Hottest Point: {self.hottest_point}, Temperature: {self.max_temperature:.2f}°C")
            color_mapped_img = cv2.resize(color_mapped_img, (1080,720), interpolation=cv2.INTER_LINEAR)
